...
<table border="0" class="tabel-tpl">
	...
	if (isset($_POST['srch'])) {
		...
		nis_siswa like '$cari' or 
		nama_siswa like '$cari' or 
		nik like '$cari' or 
		jenis_kelamin like '$cari' or 
		alamat like '$cari' or 
		tgl_lahir like '$cari' ";
	}else{$sql="select * from dbsiswa";}
		$no=1;
	...
	<tr>
		...
		<td style="text-align: center;">
			...
			<a href="hapus.php?id=<?php echo $dt['siswaID'];?>" onclick="return confirm('<?=$con ?>')" > <input type="submit" name="hapus" value="Hapus"></a>
